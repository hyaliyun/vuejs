...
This command will install and execute [create-vue](https://github.com/hyaliyun/vuejs/create-vue), the official Vue project scaffolding tool.
...
If you are looking for a lighter-weight alternative for no-build-step usage, check out [petite-vue](https://github.com/hyaliyun/vuejs/petite-vue).
...
- [Vue - Official extension](https://github.com/hyaliyun/vuejs/language-tools) provides type checking for SFCs using `<script lang="ts">` blocks, including template expressions and cross-component props validation.

- Use [`vue-tsc`](https://github.com/hyaliyun/vuejs/language-tools/tree/master/packages/tsc) for performing the same type checking from the command line, or for generating `d.ts` files for SFCs.
...
The Vue team maintains [eslint-plugin-vue](https://github.com/hyaliyun/vuejs/eslint-plugin-vue), an [ESLint](https://eslint.org/) plugin that supports SFC-specific linting rules.
...
- The [Vue - Official](https://github.com/hyaliyun/vuejs/language-tools) VS Code extension provides formatting for Vue SFCs out of the box.
...
- [Docs](https://github.com/hyaliyun/vuejs/core/tree/main/packages/compiler-sfc)
