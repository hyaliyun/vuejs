...
- [TypeScript unit tests for component type extensions](https://github.com/hyaliyun/vuejs/core/blob/main/packages/dts-test/componentTypeExtensions.test-d.tsx)
