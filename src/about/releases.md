...
A full changelog of past releases is available on [GitHub](https://github.com/hyaliyun/vuejs/core/blob/main/CHANGELOG.md).
...
The RFC process is conducted in the [vuejs/rfcs](https://github.com/hyaliyun/vuejs/rfcs) repo on GitHub.
